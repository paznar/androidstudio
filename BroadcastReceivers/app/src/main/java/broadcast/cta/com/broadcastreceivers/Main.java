...
public class Main extends ActionBarActivity {
            ...
            public void onReceive(Context context, Intent intent)
            {
                ...
                switch (intent.getAction())
                {
                    ...
                    case SaludadorIntentService.BROADCAST_ACTION_DESPEDIR:
                        Toast.makeText(context , "Adiós " + nombre + "!!!!", Toast.LENGTH_LONG).show();
                        break;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        {
            SaludadorIntentService.startActionSaludar(this, "Pablo");
            return true;
        }
        else if (id == R.id.action_despedir)
        {
            SaludadorIntentService.startActionDespedir(this, "Ermenegildo");
            return true;
        }
